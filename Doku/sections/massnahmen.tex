...
\begin{table}[H]
  \centering
  \caption{Bewertung zum Berichtsstand vor dem Merge des XSS-Fixes}
  \small
  \begin{tabularx}{\textwidth}{l l X}
    \toprule
    \textbf{Bereich} & \textbf{Status} & \textbf{Begründung}\\
    \midrule
    VueCal Stored DOM XSS & merge-bereit & Eigene Event-Slots und
    Vue-Interpolation sind auf
    \path{fix/vue-cal-xss-safe-rendering} mit Commit
    \texttt{08567da9} vollständig umgesetzt und geprüft;
    \texttt{capstone-main} und andere geprüfte
    Remote-Branches bleiben bis zum Merge anfällig.\\
...
Der merge-bereite Fix sollte mit Komponenten- oder End-to-End-Tests
