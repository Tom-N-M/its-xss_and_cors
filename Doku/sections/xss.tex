...
Der Security-Branch demonstriert den Unterschied exemplarisch mit
zwei Komponenten:
...
\path{capstone-main} ist der sichere Renderer direkt in den regulären
Ansichten umgesetzt; eine Laufzeitumschaltung zurück zur anfälligen
Variante ist dort nicht vorhanden.
...
\texttt{vue-cal}-Standardrenderer. Die weiteren relevanten
Entwicklungsbranches wurden ebenfalls geprüft und enthalten die
ursprüngliche Schwachstelle weiterhin; der Fix wurde bewusst nur auf
\texttt{capstone-main} ausgerollt. Diese Aussage bedeutet nicht, dass
...
\texttt{v-html} können dieselbe Schwachstellenklasse erneut einführen.
