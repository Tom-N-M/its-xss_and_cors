...
vorhanden. Der dauerhafte Fix wurde jedoch ausschließlich auf
\texttt{capstone-main} ausgerollt, und zwar ohne Demo-Umschaltung und
ohne schwache CORS-Konfiguration. Der Security-Branch behält dagegen
bewusst sichere und unsichere Varianten für den direkten Vergleich.
