...
XSS-Fixes direkt auf \path{capstone-main}. Die Demo-Setups wurden
dagegen im separaten, von \path{capstone-main} abgeleiteten Stand
\path{origin/its-xss-cors-security-break} umgesetzt. Absichtlich
schwache CORS-Einstellungen, Umschaltlogik und Demo-Testdaten gehören
ausschließlich zu diesem Demonstrationsstand und nicht zum
produktiven Fix.
