...
Der Bericht beschreibt den Stand des auf
\path{fix/vue-cal-xss-safe-rendering} vollständig umgesetzten und für
den Merge in \path{capstone-main} bereiten XSS-Fixes. Die Demo-Setups
wurden dagegen im separaten, von \path{capstone-main} abgeleiteten
Stand \path{origin/its-xss-cors-security-break} umgesetzt.
Absichtlich schwache CORS-Einstellungen, Umschaltlogik und
Demo-Testdaten gehören ausschließlich zu diesem Demonstrationsstand
