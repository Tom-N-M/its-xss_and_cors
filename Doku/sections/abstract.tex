...
\begin{abstract}
  ...
  dieser Fix auf \path{fix/vue-cal-xss-safe-rendering} in allen
  relevanten Kalenderansichten umgesetzt, geprüft und bereit für den
  Merge in \texttt{capstone-main}. Der konkrete Stand ist durch
  Commit \texttt{08567da9} nachvollziehbar. Auf dem Fix-Branch besteht
  nach erneuter Prüfung kein bekanntes aktuelles XSS-Risiko dieser Art.
  ...
  separaten Demo-Stand \path{origin/its-xss-cors-security-break}
  bewusst eine unsichere globale Origin-Freigabe ergänzt und
  anschließend einer festen Allowlist gegenübergestellt. Unabhängig
  davon bleiben konkrete Verbesserungen erforderlich:
  \texttt{/files/**} ist zu breit öffentlich
