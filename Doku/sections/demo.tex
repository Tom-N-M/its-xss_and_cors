...
Die XSS-Demo auf \path{origin/its-xss-cors-security-break} stellt
denselben persistent gespeicherten Wert in einer anfälligen und einer
sicheren Kalenderansicht gegenüber. Der Test
...
Die CORS-Demo auf \path{origin/its-xss-cors-security-break} verwendet
vier lokale Komponenten: Keycloak und PostgreSQL, die Spring-API auf
Port 8079, das reguläre Vue-Frontend auf Port 8078 sowie die separate
Angreifer-Demo aus \texttt{cors/index.html} auf Port 5173.
